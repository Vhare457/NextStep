...
namespace Job_Application.Hubs
{
    ...
    public class ChatHub : Hub
    {
        ...
        public override async Task OnConnectedAsync()
        {
            ...
            {
                _logger.LogWarning("⚠️ User connected without valid NameIdentifier claim. ConnectionId: {ConnectionId}", 
                    Context.ConnectionId);
                Console.WriteLine($"⚠️ SignalR: User connected without valid userId claim. ConnectionId: {Context.ConnectionId}");
            }
